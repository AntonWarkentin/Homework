...
namespace Home_11.UnitTest
{
    internal class UnitTest_Division
    {
        ...
        {
            TestMessage.CalculatorPositiveCase(operand1, operand2, operand1 / operand2, Operation.Division);
        ...
        {
            TestMessage.CalculatorNegativeCase(operand1, operand2, operand1 - operand2, Operation.Division);
